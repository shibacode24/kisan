    ...
    <div class="row">
        <div class="col-md-12" style="margin-top:-15px;">
            ...
            <div class="panel panel-default">
                ...
                <h5 class="panel-title" style="color:#FFFFFF; background-color:#0f903f; width:100%; font-size:14px;" align="center"><i class="fa fa-edit"></i> &nbsp;Regional Manager Registration </h5>
                ...
                <div class="panel-body" style="margin-top:-10px; margin-bottom:-5px;">
                    ...
                    @if(count($errors)>0)
                     ...
                     @endif
                        ...
                        <form role="form" method="POST" action="{{route('update-regional_manager')}}">
                            @csrf
                            <input type="hidden" placeholder=" " name="id" value="{{$regionalmanager_edit->id}}" class="form-control" required />
                            <div class="col-md-12">
                                <div class="form-group" style="margin-top:-10px;">
                                    ...
                                    <div class="col-md-2" style="margin-top:15px;">
                                        ...
                                        <input type="text" placeholder=" " class="form-control" required/ name="emp_id" value="{{$regionalmanager_edit->Emp_Id}}">
                                    </div>
                                    <div class="col-md-2" style="margin-top:15px;">
                                        <label>Name<font color="#FF0000">*</font></label>
                                        <input type="text" placeholder=" " class="form-control" required/ name="name" value="{{$regionalmanager_edit->Name}}">
                                    </div>

                                    <div class="col-md-2" style="margin-top:15px;">
                                        <label>Mobile Number<font color="#FF0000">*</font></label>
                                        <input type="text" placeholder=" " maxlength="10" class="form-control" required/ name="Mobile_Number" value="{{$regionalmanager_edit->Mobile_Number}}">
                                    </div>
                                    <div class="col-md-2" style="margin-top:15px;">
                                        <label>Email Id<font color="#FF0000">*</font></label>
                                        <input type="text" placeholder=" " class="form-control" required/ name="email" value="{{$regionalmanager_edit->Email_Id}}">
                                    </div>
                                    <div class="col-md-4" style="margin-top:15px;">
                                        <label>Address<font color="#FF0000">*</font></label>
                                        <input type="text" placeholder=" " class="form-control" required/ name="address" value="{{$regionalmanager_edit->Address}}">
                                    </div>
                                   
                                   
                                    <div class="col-md-2" style="margin-top:15px;">
                                        <label>State<font color="#FF0000">*</font></label>
                                        <select class="form-control select" id="state" data-live-search="true" name="state" value="{{$regionalmanager_edit->State}}">
                                            @foreach ($states as $state)
                                            <option value="{{$state->id}}" @if($regionalmanager_edit->State_id==$state->id) selected @endif>{{$state->State_Name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-2" style="margin-top:15px;">
                                        ...
                                        <select class="form-control select" name="distric" id="district" data-live-search="true">
                                            ...
                                            <option value="{{$distric->id}}"  @if($regionalmanager_edit->District_id==$distric->id) selected @endif>{{$distric->District}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-2" style="margin-top:15px;">
                                        ...
                                        @foreach ($tehsils as $tehsil)
                                                  <option value="{{$tehsil->id}}" @if($regionalmanager_edit->Tahsil_id==$tehsil->id) selected @endif>{{$tehsil->Tehsil}}</option>
                                           @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-2" style="margin-top:15px;">
                                        ...
                                        <select class="form-control select" id="city" data-live-search="true" name="city">
                                            ...
                                            <option value="{{$city->id}}" @if($regionalmanager_edit->City_id==$city->id) selected @endif>{{$city->City}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-2" style="margin-top:15px;">
                                        ...
                                        <select class="form-control select" id="region" data-live-search="true" name="region">
                                            ...
                                            <option value="{{$region->id}}" @if($regionalmanager_edit->Region_id==$region->id) selected @endif>{{$region->Region}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-2" style="margin-top:15px;">
                                        <label>Pincode<font color="#FF0000">*</font></label>
                                        <input type="number" placeholder=" " class="form-control" required/ name="pincode" value="{{$regionalmanager_edit->Pincode}}">
                                    </div>

                                    <div class="col-md-2" style="margin-top:15px;">
                                        <label>Username<font color="#FF0000">*</font></label>
                                        <input type="text" placeholder=" " class="form-control" value="{{$regionalmanager_edit->Username}}" required/ name="username">
                                    </div>
                                    <div class="col-md-2" style="margin-top:15px;">
                                    ...
                                    <div class="col-md-2" style="margin-top:5vh;">
                                        ...
                                        <div class="input-group" style=" margin-bottom:15px;">
                                            ...
                                            <button type="submit" name="regional" value="Sale" class="btn btn-primary"><span class="fa fa-plus"></span> Update </button>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div>
            <div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <h5 class="panel-title" style="color:#FFFFFF; background-color:#0f903f; width:100%; font-size:14px;" align="center"><i class="fa fa-edit"></i> Registered Regional Manager </h5>
                            ...
                            <div class="panel-body">
                                <table class="table datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>{{$loop->index+1}}</th>
                                            <td>{{$regionalmanager->Emp_Id}}</td>
                                            <td>{{$regionalmanager->Name}}</td>
                                            <td>{{$regionalmanager->Mobile_Number}}</td>
                                            <td>{{$regionalmanager->Email_Id}}</td>
                                            <td>{{$regionalmanager->Address}}</td>
                                            <td>{{$regionalmanager->State_Name}}</td>
                                            <td>{{$regionalmanager->District}}</td>
                                            <td>{{$regionalmanager->Tehsil}}</td>
                                            <td>{{$regionalmanager->City}}</td>
                                            <td>{{$regionalmanager->Region}}</td>
                                            <td>{{$regionalmanager->Pincode}}</td>
                                            <td>{{$regionalmanager->Username}}</td>
                                            <td>
                                                <a href="{{route('edit-regional_manager',$regionalmanager->id)}}"><button style="background-color:#0066cc; border:none; max-height:25px; margin-top:-5px; margin-bottom:-5px;" type="button" class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Edit "><i class="fa fa-edit" style="margin-left:5px;"></i></button>
                                                </a>
                                                <a onclick="return confirm('Are You Sure To Delete This?')" href="{{route('destroy-regional_manager',$regionalmanager->id)}}">
