            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="margin-top:-10px; margin-bottom:-5px;">
                    <div class="form-group">
                        <form role="form" method="POST" action="{{route('update-region')}}">
                            @csrf
                            <input type="hidden" placeholder=" " name="id" value="{{$region->id}}" class="form-control" required />
                                ...
                                <div class="form-group" style="margin-top:-10px;">
                                 ...
                                 <div class="col-md-2" style="margin-top:15px;">
                                        ...
                                        <select class="form-control select" data-live-search="true" name="state">
                                            ...
                                            @if($region->State_id==$state->id) selected @endif>{{$state->State_Name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-2" style="margin-top:15px;">
                                        ...
                                        <input type="text" placeholder=" " name="rr" value="{{$region->Region}}" class="form-control" required />
                                    </div>

                                    <div class="col-md-2" style="margin-top:5vh;">

                                        <div class="input-group" style=" margin-bottom:15px;">
                                            <button type="submit" name="region" value="Region" class="btn btn-primary"><span class="fa fa-plus"></span> Update </button>
                                        </div>
                                    </div>
                                </div>
                            </div>
