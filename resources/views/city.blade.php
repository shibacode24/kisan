    ...
    <div class="row">
        <div class="col-md-12" style="margin-top:-15px;">
            ...
            <div class="panel panel-default">
                ...
                <div class="col-md-10">
                    <h5 class="panel-title" style="color:#FFFFFF; background-color:#0f903f; width:100%; font-size:14px;" align="center"><i class="fa fa-edit"></i> &nbsp;City </h5>
                            ...
                            <div class="col-md-12">
                                <div class="form-group" style="margin-top:-10px;">
                                    ...
                                    <div class="col-md-2" style="margin-top:15px;">
                                        ...
                                        <select class="form-control select" name="distric" value="" id="district" data-live-search="true" required>
                                    ...
                                    <div class="col-md-2" style="margin-top:15px;">
                                        ...
                                        <input type="text" placeholder=" " name="city_name" id="city" value="" class="form-control" required />
                                    </div>
                                    ...
                                    <div class="col-md-2" style="margin-top:5vh;">
                                        ...
                                        <div class="input-group" style=" margin-bottom:15px;">
                                            ...
                                            <button type="submit" name="city" value="City" class="btn btn-primary"><span class="fa fa-plus"></span> Add </button>
                                        </div>
                                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a onclick="return confirm('Are You Sure To Delete This?')" href="{{route('destroy-city',$city->id)}}">
