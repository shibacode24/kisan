            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="margin-top:-10px; margin-bottom:-5px;">
                    <div class="form-group">
                        <form role="form" method="POST" action="{{route('create-distric')}}">
                            @csrf
                            <div class="col-md-12">
                                <div class="form-group" style="margin-top:-10px;">
                                    ...
                                    <div class="col-md-2" style="margin-top:15px;">
                                        ...
                                        <select class="form-control select" data-live-search="true" name="state" require>
                                    ...
                                    <div class="col-md-2" style="margin-top:15px;">
                                        ...
                                        <input type="text" placeholder=" " name="dd" class="form-control" required />
                                    </div>

                                    <div class="col-md-2" style="margin-top:5vh;">

                                        <div class="input-group" style=" margin-bottom:15px;">
                                            <button type="submit" name="distric" value="Distric" class="btn btn-primary"><span class="fa fa-plus"></span> Add </button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a onclick="return confirm('Are You Sure To Delete This?')" href="{{route('destroy-distric',$distric->id)}}">
