                ...
                <div class="panel-body" style="margin-top:-10px; margin-bottom:-5px;">
                    ...
                    @if(count($errors)>0)
                     ...
                     @endif
                        ...
                        <form role="form" method="POST" action="{{route('create-regional_manager')}}">
                            @csrf
                            <div class="col-md-12">
                                <div class="form-group" style="margin-top:-10px;">
                                    ...
                                    <div class="col-md-2" style="margin-top:5vh;">
                                        ...
                                        <div class="input-group" style=" margin-bottom:15px;">
                                            ...
                                            <button type="submit" name="regional" value="Sale" class="btn btn-primary"><span class="fa fa-plus"></span> Submit </button>
                                        </div>
                                    </div>
                                </div>
                            </div>
