            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="margin-top:-10px; margin-bottom:-5px;">
                    <div class="form-group">
                        <form role="form" method="POST" action="{{route('update-area_master')}}">
                            @csrf
                            <input type="hidden" placeholder=" " name="id" value="{{$areamaster->id}}" class="form-control" required />
                            <div class="col-md-12">
                                <div class="form-group" style="margin-top:-10px;">
                                    <div class="col-md-3"></div>
                                    <div class="col-md-2" style="margin-top:15px;">
                                        <label>Area<font color="#FF0000">*</font></label>
                                        <input type="text" placeholder=" " name="area"  value="{{$areamaster->area}}"  class="form-control" required />
                                    </div>
                                    <div class="col-md-2" style="margin-top:15px;">
                                        ...
                                        @foreach ($citys as $city)
                                                  <option value="{{$city->id}}"
                                                   @if($areamaster->city_id==$city->id) selected @endif>{{$city->City}}</option>
                                           @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-2" style="margin-top:15px;">
                                        ...
                                        @foreach ($states as $state)
                                                  <option value="{{$state->id}}" @if($areamaster->State_id==$state->id) selected @endif>{{$state->State_Name}}</option>
                                           @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-2" style="margin-top:5vh;">
                                        ...
                                        <div class="input-group" style=" margin-bottom:15px;">
                                            ...
                                            <button type="submit" name="areamaster" value="areamaster" class="btn btn-primary"><span class="fa fa-plus"></span> Update </button>
                                        </div>
                                    </div>
                                </div>
                            </div>
