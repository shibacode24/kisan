                ...
                <div class="panel-body" style="margin-top:-10px; margin-bottom:-5px;">
                    ...
                    @if(count($errors)>0)
                     ...
                     @endif
                        ...
                        <form role="form" method="POST" action="{{route('create-distributor')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="col-md-12">
                                <div class="form-group" style="margin-top:-10px;">
                                    ...
                                    <div class="col-md-2" style="margin-top:15px;">
                                        ...
                                        <input type="text" placeholder=" " class="form-control" required/ name="father_name">
                                    </div>
                                    ...
                                    <div class="col-md-2" style="margin-top:15px;">
                                        ...
                                        <input type="text" placeholder=" " class="form-control" required/ name="pan_card">
                                    </div>
                                    ...
                                    <div class="col-md-4" style="margin-top:15px;">
                                        ...
                                        <input type="text" placeholder=" " class="form-control" required/ name="zip_code">
                                    </div>
...
{{--                                    
                                    ...
                                    <div class="col-md-2" style="margin-top:15px;">
                                        ...
                                        <input type="file" placeholder=" " class="form-control" required/ name="front_pic">
                                    </div>
        ...
        <div>
            <div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <h5 class="panel-title" style="color:#FFFFFF; background-color:#0f903f; width:100%; font-size:14px;" align="center"><i class="fa fa-edit"></i> Registered Distributor </h5>
                                ...
                                <table class="table datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{asset('images/distributor/'.$distributor->front_pic)}}" target="_blank"><img src="{{asset('images/distributor/'.$distributor->front_pic)}}" style="width: 20%;height:20%;">
                                                </a>
                                            </td>
